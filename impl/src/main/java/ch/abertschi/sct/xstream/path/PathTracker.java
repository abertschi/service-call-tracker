 ...
 * 
 * <pre>
 *      - 10.07.2014 - Andrin Bertschi: Class is now capable to reset its internal state.
 *  </pre>
 * 
 * @see Path
...
public class PathTracker {
    ...
    /**
     * @param initialCapacity Size of the initial stack of nodes (one level per depth in the tree).
     * Note that this is only for optimizations - the stack will resize itself if it exceeds its
     * capacity. If in doubt, use the other constructor.
     */
